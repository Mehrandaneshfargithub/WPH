#pragma checksum "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Disease\dgDiseaseGrid.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b5e3949257f94681af25cae0e95a27436e6ecf9f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(WPH.Pages.Shared.PartialViews.AppWebForms.Disease.Views_Shared_PartialViews_AppWebForms_Disease_dgDiseaseGrid), @"mvc.1.0.view", @"/Views/Shared/PartialViews/AppWebForms/Disease/dgDiseaseGrid.cshtml")]
...
#nullable disable
#nullable restore
#line 2 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Disease\dgDiseaseGrid.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b5e3949257f94681af25cae0e95a27436e6ecf9f", @"/Views/Shared/PartialViews/AppWebForms/Disease/dgDiseaseGrid.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5221a2d8e2059d2e61789d73e7efe285a53b8943", @"/Views/_ViewImports.cshtml")]
    #nullable restore
    public class Views_Shared_PartialViews_AppWebForms_Disease_dgDiseaseGrid : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n\r\n");
#nullable restore
#line 7 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Disease\dgDiseaseGrid.cshtml"
  
    string edit_title = Localizer["EditDisease"];
    string remove_title = Localizer["RemoveDisease"];
...
#nullable disable
            WriteLiteral("\r\n\r\n<div>\r\n    ");
#nullable restore
#line 14 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Disease\dgDiseaseGrid.cshtml"
Write(Html.Kendo().Grid<WPH.Models.CustomDataModels.Disease.DiseaseViewModel>()
    .Name("kendoGrid")
    .Columns(columns =>
    {
        ...
        {
            if ((bool)ViewBag.AccessDeleteDisease)
            {
            ...
            if ((bool)ViewBag.AccessEditDisease)
            {
                columns.Bound("").Title(string.Empty).Width(10).HtmlAttributes(new { @style = "text-align:center;" })
                .ClientTemplate(
                   $@"<a class='tooltip-success grid-btn edit' onClick='EditDisease(this);' data-id='#=Guid#' data-rel='tooltip' title='{edit_title}' data-original-title='Edit'>
                        <span class='green'>
            ...
            columns.Bound(x => x.DiseaseTypeName).Width(100).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).Title(Localizer["DiseaseType"]).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
        ...
        else
        {
            ...
            columns.Bound(x => x.DiseaseTypeName).Width(100).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).Title(Localizer["DiseaseType"]).HtmlAttributes(new { @style = "text-align:center;" }).HeaderHtmlAttributes(new { @style = "text-align:center;" });
        ...
        .PageSize(10)
        .Read(read => read.Action("GetAll", "Disease"))
        )
