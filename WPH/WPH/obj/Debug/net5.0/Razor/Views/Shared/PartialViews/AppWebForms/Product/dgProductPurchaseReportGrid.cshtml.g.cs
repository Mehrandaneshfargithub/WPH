#pragma checksum "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Product\dgProductPurchaseReportGrid.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "555aca49137bacf6b8ab1914e15c614ab7d05e18"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(WPH.Pages.Shared.PartialViews.AppWebForms.Product.Views_Shared_PartialViews_AppWebForms_Product_dgProductPurchaseReportGrid), @"mvc.1.0.view", @"/Views/Shared/PartialViews/AppWebForms/Product/dgProductPurchaseReportGrid.cshtml")]
...
#nullable disable
#nullable restore
#line 2 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Product\dgProductPurchaseReportGrid.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"555aca49137bacf6b8ab1914e15c614ab7d05e18", @"/Views/Shared/PartialViews/AppWebForms/Product/dgProductPurchaseReportGrid.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5221a2d8e2059d2e61789d73e7efe285a53b8943", @"/Views/_ViewImports.cshtml")]
    #nullable restore
    public class Views_Shared_PartialViews_AppWebForms_Product_dgProductPurchaseReportGrid : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
...
#nullable restore
#line 46 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Product\dgProductPurchaseReportGrid.cshtml"
Write(Html.Kendo().Grid<WPH.Models.Product.ProductReportResultViewModel>()
    .Name("purchaseReportKendoGrid")
    .Columns(columns =>
    {
        ...
        if (HttpContextAccessor.HttpContext.Session.GetString("culture") != "en")
        {
            ...
            columns.Bound(x => x.MainInvoiceNum).Title(Localizer["MainInvoiceNum"]).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
        ...
        else
        {
            ...
            columns.Bound(x => x.MainInvoiceNum).Title(Localizer["MainInvoiceNum"]).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).HtmlAttributes(new { @style = "text-align:center;" }).HeaderHtmlAttributes(new { @style = "text-align:center;" });
            columns.Bound(x => x.Description).Title(Localizer["Description"]).Filterable(false).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
            columns.Bound(x => x.ExpireDate).Title(Localizer["ExpireDate"]).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
            columns.Bound(x => x.BujNumber).Title(Localizer["BujNumber"]).Filterable(false).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
