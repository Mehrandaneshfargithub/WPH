#pragma checksum "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Supplier\dgSupplierGrid.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "390174434ad58fb713a9ab2cb0be4ef52c67c4b3"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(WPH.Pages.Shared.PartialViews.AppWebForms.Supplier.Views_Shared_PartialViews_AppWebForms_Supplier_dgSupplierGrid), @"mvc.1.0.view", @"/Views/Shared/PartialViews/AppWebForms/Supplier/dgSupplierGrid.cshtml")]
...
#nullable disable
#nullable restore
#line 2 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Supplier\dgSupplierGrid.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"390174434ad58fb713a9ab2cb0be4ef52c67c4b3", @"/Views/Shared/PartialViews/AppWebForms/Supplier/dgSupplierGrid.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5221a2d8e2059d2e61789d73e7efe285a53b8943", @"/Views/_ViewImports.cshtml")]
    #nullable restore
    public class Views_Shared_PartialViews_AppWebForms_Supplier_dgSupplierGrid : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 6 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Supplier\dgSupplierGrid.cshtml"
  
    string edit_title = Localizer["EditSupplier"];
    string remove_title = Localizer["RemoveSupplier"];
...
#nullable disable
            WriteLiteral("\r\n<div>\r\n    ");
#nullable restore
#line 12 "H:\Projects\WASVersion2\WPH\WPH\Views\Shared\PartialViews\AppWebForms\Supplier\dgSupplierGrid.cshtml"
Write(Html.Kendo().Grid<WPH.Models.Supplier.SupplierViewModel>()
    .Name("kendoSupplierGrid")
    .Columns(columns =>
    {

        if (HttpContextAccessor.HttpContext.Session.GetString("culture") != "en")
        {
            if ((bool)ViewBag.AccessDeleteSupplier)
            {
            ...
            if ((bool)ViewBag.AccessEditSupplier)
            {
                columns.Bound("").Title(string.Empty).Width(10).HtmlAttributes(new { @style = "text-align:center;" })
                .ClientTemplate(
                    $@"<a class='tooltip-success grid-btn edit' onClick='EditSupplier(this);' data-id='#=Guid#' data-rel='tooltip' title='{edit_title}' data-original-title='Edit'>
                        <span class='green'>
            ...
            columns.Bound(x => x.CountryName).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).Title(Localizer["Country"]).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
            columns.Bound(x => x.SupplierTypeName).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).Title(Localizer["SupplierType"]).HtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Roboto-grid" }).HeaderHtmlAttributes(new { @style = "text-align:center;", @class = "MyFont-Sarchia-grid" });
        ...
        else
        {
            ...
            columns.Bound(x => x.SupplierTypeName).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).Title(Localizer["SupplierType"]).HtmlAttributes(new { @style = "text-align:center;" }).HeaderHtmlAttributes(new { @style = "text-align:center;" });
            columns.Bound(x => x.CountryName).Filterable(ftb => ftb.Cell(cell => cell.Operator("contains").SuggestionOperator(FilterType.Contains))).Title(Localizer["Country"]).HtmlAttributes(new { @style = "text-align:center;" }).HeaderHtmlAttributes(new { @style = "text-align:center;" });
        ...
        .PageSize(10)
        .Read(read => read.Action("GetAll", "Supplier"))
        )
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(""#kendoSupplierGrid"").on(""dblclick"", ""tr.k-state-selected"", function (element) {

            $(""#kendoSupplierGrid"").find(""tr.k-state-selected td a.edit"").click();
